...
export default function Home() {
  ...
  const hslColor11 = CardGenerator({
    hueRandom: true,
    saturation: s,
    lightness: l,
  });
  const hslColor12 = CardGenerator({
    hueRandom: true,
    saturation: s,
    lightness: l,
  });
  const hslColor21 = CardGenerator({
    hue: h,
    saturation: s,
    lightnessRandom: true,
  });
  const hslColor22 = CardGenerator({
    hue: h,
    saturation: s,
    lightnessRandom: true,
  });
  const hslColor31 = CardGenerator({
    hue: h,
    saturationRandom: true,
    lightness: l,
  });
  const hslColor32 = CardGenerator({
    hue: h,
    saturationRandom: true,
    lightness: l,
  });
  //３セットの色相ランダムカードの色を生成（CardGeneratorRandomHue）
